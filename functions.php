...
function latitude51_scripts()
{
	...
	//SSWS localize 2017 navigation script
	wp_localize_script('latitude51-navigation', 'latitude51ScreenReaderText', array(
		'expand'   => __('Expand child menu', 'latitude51'),
		'collapse' => __('Collapse child menu', 'latitude51'),
	));
